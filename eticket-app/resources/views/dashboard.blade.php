    ...
    <div class="py-12 bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50 min-h-screen wave-pattern">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
                <!-- Total Masuk Card -->
                <div class="stat-card bg-white p-6 rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl relative overflow-hidden group">
                    <div class="absolute top-0 right-0 w-24 h-24 bg-blue-50 rounded-full -mr-12 -mt-12"></div>
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-[9px] font-black text-blue-900 uppercase tracking-[0.15em]">Total Masuk</p>
                        ...
                        <div class="flex items-baseline gap-1.5">
                            <h3 class="text-4xl font-black text-blue-900 leading-none">{{ $stats['total'] }}</h3>
                            <span class="text-xs font-bold text-blue-600">Tiket</span>
                        </div>
                        <div class="mt-3 h-1.5 bg-blue-100 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-900 rounded-full" style="width: 100%"></div>
                        </div>
                    </div>
                </div>

                <!-- Menunggu Card -->
                <div class="stat-card bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-lg hover:shadow-xl relative overflow-hidden group">
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-[9px] font-black text-white uppercase tracking-[0.15em]">Menunggu</p>
                        ...
                        <div class="flex items-baseline gap-1.5 text-white">
                            <h3 class="text-4xl font-black leading-none">{{ $stats['waiting'] }}</h3>
                            <span class="text-xs font-bold">Urgent</span>
                        </div>
                        <div class="mt-3 flex items-center gap-1.5 text-white">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            </svg>
                            <span class="text-[10px] font-bold uppercase tracking-wider">Perlu Perhatian</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Resolved Card -->
                <div class="stat-card bg-white p-6 rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl relative overflow-hidden group">
                    <div class="absolute top-0 right-0 w-24 h-24 bg-emerald-50 rounded-full -mr-12 -mt-12"></div>
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-[9px] font-black text-emerald-900 uppercase tracking-[0.15em]">Resolved</p>
                        ...
                        <div class="flex items-baseline gap-1.5">
                            <h3 class="text-4xl font-black text-emerald-600 leading-none">{{ $stats['done'] }}</h3>
                        ...
                        <div class="mt-3 h-1.5 bg-emerald-100 rounded-full overflow-hidden">
                            <div class="h-full bg-emerald-600 rounded-full" style="width: {{ $stats['total'] > 0 ? ($stats['done'] / $stats['total'] * 100) : 0 }}%"></div>
                        </div>
                    </div>
                </div>

                <!-- User Aktif Card -->
                <div class="stat-card bg-gradient-to-br from-blue-900 to-blue-700 p-6 rounded-2xl shadow-lg hover:shadow-xl relative overflow-hidden group">
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-[9px] font-black text-blue-100 uppercase tracking-[0.15em]">User Aktif</p>
                        ...
                        <div class="flex items-baseline gap-1.5 text-white">
                            <h3 class="text-4xl font-black leading-none">{{ \App\Models\User::count() }}</h3>
                            <span class="text-xs font-bold">OPD</span>
                        </div>
                        <div class="mt-3 flex items-center gap-1.5 text-white/80">
                            <div class="flex -space-x-1.5">
                                <div class="w-5 h-5 rounded-full bg-orange-500 border-2 border-blue-900"></div>
                                <div class="w-5 h-5 rounded-full bg-white border-2 border-blue-900"></div>
                                <div class="w-5 h-5 rounded-full bg-orange-400 border-2 border-blue-900"></div>
                            </div>
                            <span class="text-[10px] font-bold uppercase tracking-wider">Instansi Terdaftar</span>
                        </div>
                    </div>
                </div>
            </div>
