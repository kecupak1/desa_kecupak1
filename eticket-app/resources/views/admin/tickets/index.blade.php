                                ...
                                @if($ticket->whatsapp)
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $ticket->whatsapp) }}" 
                                           target="_blank" 
                                           class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-500 text-white hover:bg-emerald-600 transition-all shadow-md shadow-emerald-500/20 text-xs font-bold">
